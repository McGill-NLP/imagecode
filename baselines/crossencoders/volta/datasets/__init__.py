...
from .vqa_dataset import VQAClassificationDataset, ContrastiveVQAClassificationDataset
...
__all__ = [
    ...
    "ContrastiveVQAClassificationDataset",
...
DatasetMapTrain = {
    ...
    "VQAcontra": ContrastiveVQAClassificationDataset,
